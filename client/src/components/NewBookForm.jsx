...
function NewBookForm() {
  const { setPreviewUrl, previewUrl, setBookModalOpen, setShowForm } =
  ...
  return (
    ...
    >
      ...
      <CoverInput />
      {!currentBook ? (
        <button className="bg-gray-200 p-2 rounded-md" onClick={submitBook}>
          Submit
        </button>
      ) : (
